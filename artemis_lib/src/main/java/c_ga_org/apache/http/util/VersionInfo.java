...
public class VersionInfo {
     ...
     *                  for example "c_ga_org.apache.http".
     ...
     * @param pkg
     *            the package for which to load version information, for example "c_ga_org.apache.http". The package name
